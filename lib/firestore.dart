...
class FirebaseManagement extends GetxController {
  ...
  //List<LikeModel> likes = <LikeModel>[].obs; // Liste des "likes" du client
  List<CommandeModel> commandes =
      <CommandeModel>[].obs; // Liste des commandes du client
  List<PanierModel> panniers =
      <PanierModel>[].obs; // Liste des paniers du client
  // List<FavorisModel> favoris = <FavorisModel>[].obs;
